...
- Ravensgateはグラント・モリスンの意見に同意する。しかしながら自慰行為では「意図」をキープするのは難しいだろうと考え Detonosisという概念を使う。
- この概念は、マントラなどで構築した魔術的意識状態の中で全身全霊でその現実を「選びきる」瞬間に生じる、不可逆の「決断」を指す。
- 自分にあった手法をPDCAサイクルを通じて模索するというのは、Ravensgateの哲学と完全に一致する。
